...
public class EveGUI extends javax.swing.JFrame {
    ...
    public EveGUI() {
        ...
        eveScreen.setEditable(false);
    }

    public void appendEveScreen(Object o) {
        eveScreen.append(o + "\n");
    }
    ...
    private void initComponents() {
        ...
        eveScreen = new javax.swing.JTextArea();
        joinButton = new javax.swing.JButton();
        leaveButton = new javax.swing.JButton();
        EveTextBox = new javax.swing.JTextField();
        labelEve = new javax.swing.JLabel();
        ...
        eveScreen.setBackground(new java.awt.Color(204, 204, 255));
        eveScreen.setColumns(20);
        eveScreen.setFont(new java.awt.Font("High Tower Text", 0, 14)); // NOI18N
        eveScreen.setRows(5);
        jScrollPane1.setViewportView(eveScreen);
        ...
        EveTextBox.setBackground(new java.awt.Color(153, 153, 255));
        EveTextBox.setFont(new java.awt.Font("High Tower Text", 0, 13)); // NOI18N
        EveTextBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EveTextBoxActionPerformed(evt);
            }
        });

        labelEve.setFont(new java.awt.Font("Magneto", 1, 18)); // NOI18N
        labelEve.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        labelEve.setText("WeChat");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(labelEve, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(28, 28, 28))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(76, 76, 76)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(8, 8, 8)
                        .addComponent(labelEve, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(sendButton)
                    .addComponent(EveTextBox, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void joinButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_joinButtonActionPerformed
        try {
            ...
            Message mes = new Message("all", "Eve", "join", false);
            //String s = "join";
            out.writeObject(mes);
            Member m = new Member(4444, "Eve");
            out.writeObject(m);
            out.close();
            in.close();
            toCordinator.close();
    ...
    private void EveTextBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EveTextBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_EveTextBoxActionPerformed
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        ...
        if (publicRadio.isSelected() && leaveButton.isEnabled()) {
            try {
                ...
                Message msg = new Message("all", "Eve", EveTextBox.getText(), false);

                out.writeObject(msg);
                appendEveScreen("Me: " + EveTextBox.getText());
                EveTextBox.setText("");
                Member m = new Member(4444, "Eve");
                out.writeObject(m);
                out.close();
            ...
            try {
                Socket sendToNext = new Socket("localhost", Eve.eveNextNode);
                ObjectOutputStream oos = new ObjectOutputStream(sendToNext.getOutputStream());
                Message pm = new Message(recepientBox.getText(), "Eve", EveTextBox.getText(), true);
                pm.encryptMsg();
                oos.writeObject(pm);
                EveTextBox.setText("");
                oos.close();
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        labelEve.setText(recepientBox.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EveGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField EveTextBox;
    private javax.swing.JTextArea eveScreen;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JButton joinButton;
    private javax.swing.JLabel labelEve;
