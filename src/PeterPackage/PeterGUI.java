...
public class PeterGUI extends javax.swing.JFrame {

    /**
     * Creates new form PeterGUI
     */
    public PeterGUI() {
        initComponents();
        this.setTitle("Peter");
        ...
        peterScreen.setEditable(false);
    }

    public void appendPeterScreen(Object o) {
        peterScreen.append(o + "\n");
    }
    ...
    private void initComponents() {
        ...
        puborprivate = new javax.swing.ButtonGroup();
        ...
        peterScreen = new javax.swing.JTextArea();
        joinButton = new javax.swing.JButton();
        leaveButton = new javax.swing.JButton();
        PeterTextBox = new javax.swing.JTextField();
        labelPeter = new javax.swing.JLabel();
        ...
        peterScreen.setBackground(new java.awt.Color(204, 204, 255));
        peterScreen.setColumns(20);
        peterScreen.setFont(new java.awt.Font("High Tower Text", 0, 14)); // NOI18N
        peterScreen.setRows(5);
        jScrollPane1.setViewportView(peterScreen);
        ...
        PeterTextBox.setBackground(new java.awt.Color(153, 153, 255));
        PeterTextBox.setFont(new java.awt.Font("High Tower Text", 0, 13)); // NOI18N
        PeterTextBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PeterTextBoxActionPerformed(evt);
            }
        });

        labelPeter.setFont(new java.awt.Font("Magneto", 1, 18)); // NOI18N
        labelPeter.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        labelPeter.setText("WeChat");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(labelPeter, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(28, 28, 28))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(76, 76, 76)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(8, 8, 8)
                        .addComponent(labelPeter, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(sendButton)
                    .addComponent(PeterTextBox, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        ...
        if (publicRadio.isSelected() && leaveButton.isEnabled()) {
            try {
                ...
                Message msg = new Message("all", "Peter", PeterTextBox.getText(), false);

                out.writeObject(msg);
                appendPeterScreen("Me: " + PeterTextBox.getText());
                PeterTextBox.setText("");
                Member m = new Member(2222, "Peter");
                out.writeObject(m);
                out.close();
                in.close();
                toCordMsg.close();
            ...
            try {
                Socket sendToNext = new Socket("localhost", Peter.peterNextNode);
                ObjectOutputStream oos = new ObjectOutputStream(sendToNext.getOutputStream());
                Message pm = new Message(recepientBox.getText(), "Peter", PeterTextBox.getText(), true);
                pm.encryptMsg();
                oos.writeObject(pm);
                PeterTextBox.setText("");
                oos.close();
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        labelPeter.setText(recepientBox.getText());
    ...
    private void joinButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_joinButtonActionPerformed
        try {
            ...
            Message mes = new Message("all", "Peter", "join", false);
            //String s = "join";
            out.writeObject(mes);
            Member m = new Member(2222, "Peter");
            out.writeObject(m);
    ...
    private void PeterTextBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PeterTextBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PeterTextBoxActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeterGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PeterGUI().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField PeterTextBox;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JButton joinButton;
    private javax.swing.JLabel labelPeter;
    private javax.swing.JButton leaveButton;
    private javax.swing.JTextArea peterScreen;
    private javax.swing.JRadioButton privateRadio;
    private javax.swing.JRadioButton publicRadio;
    private javax.swing.ButtonGroup puborprivate;
